  ...
  <div class="max-w-4xl mx-auto">
    ...
    <div class="flex flex-col md:flex-row gap-12 items-center mb-16">
      <div class="md:w-2/3 space-y-6">
        ...
        <p class="text-base md:text-lg text-gray-600 leading-relaxed italic font-medium">
      ...
      <div class="md:w-1/3 flex justify-center">
        <img src="/assets/eb-clean.jpg" alt="EB Khiyami Profile" class="w-48 h-48 md:w-80 md:h-80 rounded-full object-cover shadow-xl border-4 border-white" style="image-rendering: -webkit-optimize-contrast; image-rendering: crisp-edges;">
      </div>
    </div>
  </div>
</div>
...
<div class="grid md:grid-cols-2 gap-8 mb-12">
  ...
  <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
    ...
    <div class="space-y-4">
      ...
      <div class="border-l-4 border-gray-300 pl-4 py-2 hover:bg-gray-50 transition-colors duration-200 rounded-r-lg">
        <h3 class="text-lg font-semibold text-black">B.S. in Computer Engineering</h3>
        <a href="http://www.damascusuniversity.edu.sy/" target="_blank" class="text-gray-600 font-medium hover:underline">Damascus University</a>
