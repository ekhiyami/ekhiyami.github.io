    ...
    <div class="mb-16">
      <div class="relative">
        <h1 class="text-2xl md:text-3xl font-light text-black tracking-tight leading-tight">
          Career <span class="px-3 py-1 bg-black text-white rounded-md relative">Mentoring
...
<div class="bg-white rounded-2xl shadow-xl p-8 md:p-12 mb-16 border border-gray-200">
  ...
  <div class="grid md:grid-cols-2 gap-8">
    <!-- Testimonial 1 -->
    <div class="bg-gray-50 rounded-xl border border-black p-6 hover:shadow-md transition-shadow">
      <div class="flex mb-3">
  ...
  <!-- Hidden testimonials -->
  <div id="more-testimonials" class="hidden grid md:grid-cols-2 gap-8 mt-8">
  ...
  <div class="text-center mt-8">
    <button id="show-more-btn" onclick="toggleTestimonials()" class="inline-flex items-center px-6 py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors font-medium">
      <i data-lucide="chevron-down" class="w-4 h-4 mr-2" id="chevron-icon"></i>
      <span id="btn-text">Show More Testimonials</span>
    </button>
  </div>
</div>
